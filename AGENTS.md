...
Development: `shellcheck` on `lib/` and `bin/`; `tests/run-tests.sh` (requires [bats](https://github.com/bats-core/bats-core) — see `docs/REQUIREMENTS.md`).

User-facing issues: `docs/TROUBLESHOOTING.md`.
